...
BATCH_SIZE = 8
# checkpoint_path = './checkpoints/c3d_fabo.pth.tar'
...
def main():
    ...
    # w_loss = torch.from_numpy(np.array([10/29, 10/34, 10/30, 10/66, 10/46, 10/35, 10/103, 10/38, 10/114, 10/51], dtype=np.float32)).to(device)
    # w_loss = w_loss**2
    ...
    train(trainloader, net, criterion, optimizer, start_epoch=start_epoch, num_epoch=100, report_step=5)
    test(testloader, net, criterion)
